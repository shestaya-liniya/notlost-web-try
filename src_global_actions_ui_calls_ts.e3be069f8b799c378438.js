...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('openThread', async (global, actions, payload) => {
  ...
  const result = (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectIsCurrentUserFrozen)(global) ? undefined : await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('fetchDiscussionMessage', {
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('updateChatMutedState', (global, actions, payload) => {
  ...
  if ((0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectIsCurrentUserFrozen)(global)) {
  ...
  if (isMuted && !mutedUntil) {
    mutedUntil = _config__WEBPACK_IMPORTED_MODULE_2__.MAX_INT_32;
  }
  void (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('updateChatNotifySettings', {
    chat,
    settings: {
      mutedUntil
    }
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('updateChatSilentPosting', (global, actions, payload) => {
  const {
    chatId,
    isEnabled
  } = payload;
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('markChatUnread', (global, actions, payload) => {
  const {
    id
  } = payload;
  if ((0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectIsCurrentUserFrozen)(global)) {
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('markChatMessagesRead', async (global, actions, payload) => {
  if ((0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectIsCurrentUserFrozen)(global)) return;
  const {
    id
  } = payload;
  if ((0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectIsCurrentUserFrozen)(global)) {
  ...
  if (!chat) return;
  if (!chat.isForum) {
    await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('markMessageListRead', {
      chat,
      threadId: _api_types__WEBPACK_IMPORTED_MODULE_0__.MAIN_THREAD_ID
    });
  ...
  while (hasMoreTopics) {
    const result = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('fetchTopics', {
      ...
      offsetId: lastTopic?.lastMessageId,
      limit: 100
    });
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('markChatRead', (global, actions, payload) => {
  const {
    id
  } = payload;
  const chat = (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectChat)(global, id);
  if (!chat) return;
  (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('toggleDialogUnread', {
    chat,
    hasUnreadMark: !chat.hasUnreadMark
  });
});
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('openPrivateChannel', (global, actions, payload) => {
  const {
    id,
    commentId,
    messageId,
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('loadMoreMembers', async (global, actions, payload) => {
  ...
  const result = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('fetchMembers', {
    chat,
    offset
  });
  if (!result) {
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('loadChannelRecommendations', async (global, actions, payload) => {
  ...
  global = (0,_index__WEBPACK_IMPORTED_MODULE_15__.getGlobal)();
  global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.replaceSimilarChannels)(global, chatId || _config__WEBPACK_IMPORTED_MODULE_2__.GLOBAL_SUGGESTED_CHANNELS_ID, Object.keys(chatsById), count);
  (0,_index__WEBPACK_IMPORTED_MODULE_15__.setGlobal)(global);
});
...
(0,_index__WEBPACK_IMPORTED_MODULE_15__.addActionHandler)('updatePaidMessagesPrice', async (global, actions, payload) => {
  const {
    chatId,
    paidMessagesStars,
    tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_6__.getCurrentTabId)()
  ...
  global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.updateManagementProgress)(global, _types__WEBPACK_IMPORTED_MODULE_1__.ManagementProgress.InProgress, tabId);
  (0,_index__WEBPACK_IMPORTED_MODULE_15__.setGlobal)(global);
  const result = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('updatePaidMessagesPrice', {
    chat,
    paidMessagesStars
  });
  if (!result) return;
...
async function loadChats(listType, isFullDraftSync, shouldIgnorePagination) {
  ...
  const isAccountFreeze = (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectIsCurrentUserFrozen)(global);
  ...
  if (shouldReplaceStaleState) {
    ...
    global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.replaceNotifyExceptions)(global, result.notifyExceptionById);
  } else {
    global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.addUserStatuses)(global, result.userStatusesById);
    global = (0,_reducers__WEBPACK_IMPORTED_MODULE_16__.addNotifyExceptions)(global, result.notifyExceptionById);
  }
...
async function loadFullChat(global, actions, chat) {
  if ((0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectIsCurrentUserFrozen)(global)) return undefined;
...
async function openChatWithParams(global, actions, chat, params, ...[tabId = (0,_util_establishMultitabRole__WEBPACK_IMPORTED_MODULE_6__.getCurrentTabId)()]) {
  const {
    isCurrentChat,
    threadId,
    messageId,
  ...
  if (messageId) {
    ...
    if (chat.isForum && !threadId) {
      let topic = (0,_selectors__WEBPACK_IMPORTED_MODULE_19__.selectTopics)(global, chat.id)?.[messageId];
      if (!topic) {
        const topicResult = await (0,_api_gramjs__WEBPACK_IMPORTED_MODULE_13__.callApi)('fetchTopicById', {
          chat,
          topicId: messageId
        });
...
(0,_index__WEBPACK_IMPORTED_MODULE_9__.addActionHandler)('subscribeToGroupCallUpdates', async (global, actions, payload) => {
  if ((0,_selectors__WEBPACK_IMPORTED_MODULE_12__.selectIsCurrentUserFrozen)(global)) return;
  const {
    subscribed,
    id
  } = payload;
...
//# sourceMappingURL=src_global_actions_ui_calls_ts.e3be069f8b799c378438.js.map